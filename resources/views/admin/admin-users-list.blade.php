    ...
    <div class="card">
        <div class="card-body">
            <div class="float-right">
                <a  href="{{ route('create.admin') }}"  class="btn float-right"> <i style="font-size:25px;color:green;" title="Create Admin User" class="fa fa-plus-square"></i> </a>
            </div>
...
<script>
    ...
    $('.status').on('click', function() {
        ...
        $.ajax({
            type: "post",
            url: "{{url('/admin/update-admin-user-status')}}",
            headers: {
